...
{
    internal sealed class NegativeArraySizeExceptionClass : LibraryClass
    {
        public static readonly string Name = "java/lang/NegativeArraySizeException";

        public NegativeArraySizeExceptionClass()
            : base(
                Name,
